...
export const species: Record<string, Species> = {
  emberMochi: {
    ...
    baseStats: { hp: 62, spirit: 70, focus: 52, speed: 64 }, moveIds: ['emberTap', 'starBump', 'flareRush'], tameRate: 0.42,
  },
  rippleFin: {
    id: 'rippleFin', name: '澜鳍兽', element: 'water', symbol: '澜', description: '喜欢在星港水边散步。',
    baseStats: { hp: 68, spirit: 62, focus: 60, speed: 58 }, moveIds: ['bubblePop', 'starBump', 'tidePulse'], tameRate: 0.44,
  },
  sproutTanuki: {
    id: 'sproutTanuki', name: '森芽狸', element: 'nature', symbol: '芽', description: '头顶的小芽会随着心情开合。',
    baseStats: { hp: 66, spirit: 64, focus: 58, speed: 62 }, moveIds: ['leafCut', 'starBump', 'seedBurst'], tameRate: 0.45,
  },
  voltFinch: {
    id: 'voltFinch', name: '闪羽雀', element: 'electric', symbol: '闪', description: '总在追逐远处的亮光。',
    baseStats: { hp: 54, spirit: 72, focus: 46, speed: 82 }, moveIds: ['sparkNibble', 'starBump', 'staticBolt'], tameRate: 0.36,
  },
  stoneShell: {
    id: 'stoneShell', name: '岩壳龟', element: 'rock', symbol: '岩', description: '步伐很慢，但很有耐心。',
    baseStats: { hp: 78, spirit: 60, focus: 82, speed: 32 }, moveIds: ['pebbleShot', 'starBump'], tameRate: 0.34,
  },
  starlitBun: {
    id: 'starlitBun', name: '星辉兔', element: 'neutral', symbol: '星', description: '夜里耳尖会浮现微弱星点。',
    baseStats: { hp: 58, spirit: 58, focus: 54, speed: 76 }, moveIds: ['starBump'], tameRate: 0.55,
  },
};
