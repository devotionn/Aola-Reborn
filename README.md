...
## 当前里程碑：v0.8 mist investigation & battle items
...
仓库名中的 `Aola` 仅作为开发阶段代号。项目不应直接复制原作角色、地图、剧情、音乐、美术或其他受保护资产。公开发行或商业化时应使用原创品牌和原创资产。
